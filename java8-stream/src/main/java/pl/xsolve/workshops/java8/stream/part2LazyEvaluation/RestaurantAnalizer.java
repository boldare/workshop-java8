...
public abstract class RestaurantAnalizer {
    ...
    public abstract boolean isAllEntriesFreeWifi(String fileName) throws URISyntaxException, IOException;

    protected Restaurant lineToRestaurant(String line) {
